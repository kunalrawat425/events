      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:block relative h-[600px] rounded-2xl overflow-hidden">
          ...
          <div className="absolute bottom-8 left-8 text-white">
            <h2 className="text-3xl font-bold mb-2">Grow Your Event Business</h2>
            <p className="text-white/80">Join our platform and reach thousands of potential attendees</p>
          </div>
        </div>
        ...
        <Card className="w-full max-w-md mx-auto bg-background/50 backdrop-blur-lg border border-foreground/10">
          <CardBody className="p-8">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold mb-2">Create Publisher Account</h1>
            ...
            <p className="mt-6 text-center text-sm text-foreground/60">
              ...
              <a href="/publisher/login" className="text-primary hover:underline">
                Sign in
              </a>
            </p>
          </CardBody>
